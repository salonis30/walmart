...
# Sample Data Loading (Update with actual dataset path)
file_path = r"C:\\Users\\salon\\Downloads\\freshwalmart\\Walmart_cleaned_filtered_limited.csv"  # Replace with your actual file path
